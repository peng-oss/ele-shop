  ...
  <div class="pay">
    ...
    <div class="main" v-if="orderInfo">
      ...
      <section class="home">
        ...
        <ul class="list payment-list-item">
      ...
      <button @click="pay" class="btn-submit" :disabled="timeout">
        确认支付
      </button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    addOrder(){
     ...
     this.$http.post(`/api/user/add_order/${localStorage.ele_login}`,orderList).then(res=>{
