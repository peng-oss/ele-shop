    ...
    <div class="menuview">
      ...
      <div class="foods-wrapper" ref="foodScroll">
        <ul>
          ...
          >
            <!--   内容上 -->
            <div class="category-title foodlist">
...
<script>
import ChartControll from '../../components/shops/ChartControll'
...
export default {
  ...
  methods: {
    ...
    initScroll() {
      let wrapper1 = this.$refs.menuScroll
      let wrapper2 = this.$refs.foodScroll
      this.menuScroll = new BScroll(wrapper1, {
        click: true,
      })
      this.foodScroll = new BScroll(wrapper2, {
        click: true,
        probeType: 3,
      })
    ...
    selectkey(index) {
      ...
      this.foodScroll.scrollToElement(foodel, 250)
    },
    calculateHeight() {
