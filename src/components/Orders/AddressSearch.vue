<template>
  <div v-if="showSearch===true" class="addressSearch">
...
watch:{
  search_address:'watchaddress'
},
computed:{
   city(){
     return this.$store.getters.location.addressComponent.province||this.$store.getters.location.addressComponent.city
   }
},
methods:{
  watchaddress(value){
