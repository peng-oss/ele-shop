<template>
  ...
  >
    <!--  导航 -->
    <div class="filter_wrap" v-if="fifterData">
      <aside class="filter">
        <div
          class="filter-nav"
          v-for="(item, index) in fifterData.navTab"
          :key="index"
    ...
    <section class="filter-extend" v-if="isSort">
      <ul>
        <li
          v-for="(item, index) in fifterData.sortBy"
          :key="index"
    ...
    <section class="filter-extend" v-if="isScreen">
      <div class="filter-sort">
        <div
          v-for="(screen, index) in fifterData.screenBy"
          :key="index"
          class="morefilter"
        >
      ...
      <div class="morefilter-btn">
        ...
        <span class="morefilter-ok" @click="fifterOk">确定</span>
      </div>
    </section>
  </div>
</template>
...
export default {
  ...
  computed: {
   edit(){
     let edit=false
     this.fifterData.screenBy.forEach(screen=>{
  ...
  methods: {
    filterSort(index) {
      ...
      switch (index) {
        ...
        case 1:
          this.$emit('updata', {
            condition: this.fifterData.navTab[1].condition,
          })
          this.hideView()
          break
        case 2:
          this.$emit('updata', {
            condition: this.fifterData.navTab[2].condition,
          })
          this.hideView()
          break
        case 3:
    ...
    selectSort(item, index) {
      ...
      this.fifterData.navTab[0].name = item.name
      this.hideView()
      //更新数据
